<div class="flex flex-col w-full lg:w-1/2 px-0 mt-8 lg:px-12 lg:mt-0">
    ...
    <div class="flex flex-row items-center justify-between w-full mt-2">
        ...
        <span class="text-sx font-thin text-success-600">In Stock</span>
    </div>
    ...
    <div class="flex flex-row flex-shrink-0 items-start mt-2 space-x-2" x-data="{color:'bg-red-500'}">
        ...
        <div @click="color ='bg-red-400'" :class="{'ring-2 ring-blue-400': color === 'bg-red-400'}" class="cursor-pointer rounded-full bg-red-400 h-4 w-4"></div click="color ='bg-red-500'">
        <div @click="color ='bg-red-300'" :class="{'ring-2 ring-blue-400': color === 'bg-red-300'}" class="cursor-pointer rounded-full bg-red-300 h-4 w-4"></div click="color ='bg-red-500'">
        <div @click="color ='bg-blue-500'" :class="{'ring-2 ring-blue-400': color === 'bg-blue-500'}" class="cursor-pointer rounded-full bg-blue-500 h-4 w-4"></div click="color ='bg-red-500'">
        <div @click="color ='bg-blue-600'" :class="{'ring-2 ring-blue-400': color === 'bg-blue-600'}" class="cursor-pointer rounded-full bg-blue-600 h-4 w-4"></div click="color ='bg-red-500'">
